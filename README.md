本插件是small_5在我的TG群的时候主导开发的.经过他同意上传到我的github并命名为luci-app-dnsfilter,我只是按照自己需求去掉了默认的主规则Easylist以及后续的维护工作,本仓库上传于2021年1月22号,从第一天上传Makefile维护名单里第一个就是他,他4月1号因为一点小事主动退的群
